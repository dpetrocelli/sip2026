...
> 🤝 **Partes 3 y 4 se entregan el mismo día (05/05) en un solo push final.** Trabajalas en paralelo: a medida que la Parte 3 te muestra que OTel funciona, andá tomando las mediciones del Hit #1 de esta Parte 4. Cuando termina la Parte 3, el Hit #3 (ADR magisterial) ya está respaldado por datos reales de tu cluster.
...
1. **Push final al repo público** (mismo repo del TP 0/1/2) antes del **05/05/2026 23:59 ART**.
