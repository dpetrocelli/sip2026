...
> **Pre-requisitos**: Partes 1, 2 y 3 entregadas y corriendo. **Necesitan tener los 3 stacks vivos** durante la entrega para tomar las mediciones empíricas (Hit #1).
...
- Archivo: `docs/adr/0010-stack-de-observabilidad-final.md`.
...
- **Repo público** (mismo del TP 0/1/2) con todos los entregables nuevos en `docs/observability-final/`:
  ...
  docs/
  ├── adr/
  │   └── 0010-stack-de-observabilidad-final.md   ← ADR magisterial (Hit #3)
  └── observability-final/
...
```bash
wc -w docs/adr/0010-stack-de-observabilidad-final.md
...
1. **Push final al repo público** (mismo repo del TP 0/1/2) antes del **06/06/2026 23:59 ART**.
...
4. **`docs/adr/0010-stack-de-observabilidad-final.md`** ≥ 1500 palabras.
